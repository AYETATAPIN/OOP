...
class MainTest {
    ...
    public void reversed_test() {
        Arrays.equals(new int[]{1, 2, 3, 4, 5}, sortingMachine.heapsort(new int[]{5, 4, 3, 2, 1}));
    }

    public void same_elements_test() {
        Arrays.equals(new int[]{1, 1, 1, 1, 1}, sortingMachine.heapsort(new int[]{1, 1, 1, 1, 1}));
    }

    public void single_element_test() {
        Arrays.equals(new int[]{1}, sortingMachine.heapsort(new int[]{1}));
    }

    public void two_elements_sorted_test() {
        Arrays.equals(new int[]{1, 5}, sortingMachine.heapsort(new int[]{1, 5}));
    }

    public void two_elements_unsorted_test() {
        Arrays.equals(new int[]{1, 5}, sortingMachine.heapsort(new int[]{5, 1}));
    }

    public void sorted_test() {
        Arrays.equals(new int[]{1, 2, 3, 4, 5}, sortingMachine.heapsort(new int[]{1, 2, 4, 3, 5}));
    }
