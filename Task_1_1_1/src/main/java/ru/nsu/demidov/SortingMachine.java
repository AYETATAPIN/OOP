...
public class SortingMachine {
    ...
    public static void main(String[] args) { // idk wouldn't run without it
        ...
        for (int i = 0; i < 1000; ++i) {
            arr1000[i] = number.nextInt(-1000000, 1000000) + 1;
        }
        ...
        for (int i = 0; i < 10000; ++i) {
            arr10000[i] = number.nextInt(-1000000, 1000000) + 1;
        }
        ...
        for (int i = 0; i < 100000; ++i) {
            arr100000[i] = number.nextInt(-1000000, 1000000) + 1;
        }
        time = System.currentTimeMillis();
        ...
        for (int i = 0; i < 1000000; ++i) {
            arr1000000[i] = number.nextInt(-1000000, 1000000) + 1;
        }
        time = System.currentTimeMillis();
        ...
        for (int i = 0; i < 2000000; ++i) {
            arr2000000[i] = number.nextInt(-1000000, 1000000) + 1;
        }
        time = System.currentTimeMillis();
        ...
        for (int i = 0; i < 5000000; ++i) {
            arr5000000[i] = number.nextInt(-1000000, 1000000) + 1;
        }
        time = System.currentTimeMillis();
        ...
        for (int i = 0; i < 10000000; ++i) {
            arr10000000[i] = number.nextInt(-1000000, 1000000) + 1;
        }
        time = System.currentTimeMillis();
